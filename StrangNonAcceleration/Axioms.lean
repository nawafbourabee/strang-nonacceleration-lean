...
-- Corollary 1.3 (deduction from Theorems 1.1 and 5.1)
#print axioms OBABO.corollary_1_3_i
#print axioms OBABO.corollary_1_3_ii
-- Tier 1: finite, algebraic and numerical lemmas
...
-- Section 2: deterministic content
...
-- Section 3: attracting neighborhood of the cycle (Theorem 3.1(ii)) and the invariant tube
...
-- Lemma 3.3, Steps 2 and 3 (Section3.lean, Part E)
